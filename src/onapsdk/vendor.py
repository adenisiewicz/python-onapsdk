...
class Vendor(SdcElement):
    ...
    def __init__(self, name: str = None):
        ...
        self.headers = headers_sdc_creator(SdcElement.headers)
    ...
    def path() -> str:
        """
        Give the specific part of path for Sdc Vendor.

        Returns:
            str: the specific part

        """
        return "vendor-license-models"
